...
new class extends Component {
    ...
    public function submit()
    {
        ...
        $this->filters = $this->only(['name', 'mobile', 'active']);
        // dd($this->filters);
        $this->closeModal();
    }
            ...
            <div class="flex flex-col gap-4">
                ...
                <div>
                    <label class="block text-sm text-gray-600 mb-1">
                        <input wire:model="name" type="text" placeholder="نام کاربر"
                ...
                <div>
                    ...
                    <select wire:model="active" class="w-full border border-gray-300 rounded-xs text-sm py-2 ">
